...
const Footer = () => {
  return (
    <footer className="relative animate-fade-in overflow-hidden">
      {/* Full Footer Background Image with Blur */}
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 backdrop-blur-[3px] bg-background/80 dark:bg-background/85" />


      </div>

      {/* Content */}
      <div className="relative z-10 py-16 border-t border-border">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {/* Company Info - Restored round logo with scale */}
            <div className="space-y-4">
              <a href="#home" className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full overflow-hidden bg-background shadow-lg ring-2 ring-primary/20 flex items-center justify-center">
                  <img src={giraLogo} alt="Gira AI Logo" className="w-10 h-10 object-cover rounded-full scale-[2.5]" />
                </div>
                <div className="flex flex-col">
                  <span className="text-[15px] text-primary tracking-widest uppercase">
                    GIRA AI
                  </span>
              ...
              <div className="flex gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-lg bg-black flex items-center justify-center transition-all hover:scale-110"
                >
                  <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
